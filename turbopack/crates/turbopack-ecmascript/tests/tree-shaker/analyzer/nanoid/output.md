...
```js
import { urlAlphabet } from './url-alphabet/index.js';
export { urlAlphabet as _ } from "__TURBOPACK_VAR__" assert {
...
```js
let poolOffset;
export { poolOffset as _ } from "__TURBOPACK_VAR__" assert {
    __turbopack_var__: true
};
...
```js
import crypto from 'crypto';
export { crypto as _ } from "__TURBOPACK_VAR__" assert {
    __turbopack_var__: true
};
...
```js
const POOL_SIZE_MULTIPLIER = 128;
export { POOL_SIZE_MULTIPLIER as _ } from "__TURBOPACK_VAR__" assert {
    __turbopack_var__: true
};
...
```js
let pool;
export { pool as _ } from "__TURBOPACK_VAR__" assert {
    __turbopack_var__: true
};
...
import { _ as pool } from "__TURBOPACK_PART__" assert {
    __turbopack_part__: 4
};
import { _ as POOL_SIZE_MULTIPLIER } from "__TURBOPACK_PART__" assert {
    __turbopack_part__: 3
};
import { _ as crypto } from "__TURBOPACK_PART__" assert {
    __turbopack_part__: 2
};
import { _ as poolOffset } from "__TURBOPACK_PART__" assert {
    __turbopack_part__: 1
};
let fillPool = (bytes)=>{
    if (!pool || pool.length < bytes) {
...
export { fillPool as _ } from "__TURBOPACK_VAR__" assert {
    __turbopack_var__: true
};
...
export { customRandom as _ } from "__TURBOPACK_VAR__" assert {
    __turbopack_var__: true
};
...
import { _ as customRandom } from "__TURBOPACK_PART__" assert {
    __turbopack_part__: 8
};
...
import { _ as fillPool } from "__TURBOPACK_PART__" assert {
    __turbopack_part__: 7
};
import { _ as pool } from "__TURBOPACK_PART__" assert {
    __turbopack_part__: 4
...
export { random as _ } from "__TURBOPACK_VAR__" assert {
    __turbopack_var__: true
};
...
import { _ as random } from "__TURBOPACK_PART__" assert {
    __turbopack_part__: 11
};
...
import { _ as urlAlphabet } from "__TURBOPACK_PART__" assert {
    __turbopack_part__: 0
};
import { _ as pool } from "__TURBOPACK_PART__" assert {
    __turbopack_part__: 4
...
export { nanoid as _ } from "__TURBOPACK_VAR__" assert {
    __turbopack_var__: true
};
...
import { _ as nanoid } from "__TURBOPACK_PART__" assert {
    __turbopack_part__: 13
};
...
let customAlphabet = (alphabet, size)=>customRandom(alphabet, size, random);
export { customAlphabet as _ } from "__TURBOPACK_VAR__" assert {
    __turbopack_var__: true
};
...
import { _ as customAlphabet } from "__TURBOPACK_PART__" assert {
    __turbopack_part__: 16
};
