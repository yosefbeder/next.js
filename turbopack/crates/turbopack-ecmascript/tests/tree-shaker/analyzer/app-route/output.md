...
```js
const originalPathname = 'VAR_ORIGINAL_PATHNAME';
export { originalPathname as _ } from "__TURBOPACK_VAR__" assert {
...
import { _ as originalPathname } from "__TURBOPACK_PART__" assert {
    __turbopack_part__: 0
};
...
```js
import { patchFetch as _patchFetch } from '../../server/lib/patch-fetch';
export { _patchFetch as _ } from "__TURBOPACK_VAR__" assert {
    __turbopack_var__: true
};
...
```js
import { AppRouteRouteModule } from '../../server/future/route-modules/app-route/module.compiled';
export { AppRouteRouteModule as _ } from "__TURBOPACK_VAR__" assert {
    __turbopack_var__: true
};
...
import { _ as AppRouteRouteModule } from "__TURBOPACK_PART__" assert {
    __turbopack_part__: 5
};
...
const { requestAsyncStorage, staticGenerationAsyncStorage, serverHooks } = routeModule;
export { requestAsyncStorage as _ } from "__TURBOPACK_VAR__" assert {
    __turbopack_var__: true
};
export { staticGenerationAsyncStorage as _ } from "__TURBOPACK_VAR__" assert {
    __turbopack_var__: true
};
export { serverHooks as _ } from "__TURBOPACK_VAR__" assert {
    __turbopack_var__: true
};
...
import { _ as serverHooks } from "__TURBOPACK_PART__" assert {
    __turbopack_part__: 13
};
...
import { _ as staticGenerationAsyncStorage } from "__TURBOPACK_PART__" assert {
    __turbopack_part__: 13
};
...
import { _ as _patchFetch } from "__TURBOPACK_PART__" assert {
    __turbopack_part__: 2
};
import { _ as serverHooks } from "__TURBOPACK_PART__" assert {
    __turbopack_part__: 13
...
export { patchFetch as _ } from "__TURBOPACK_VAR__" assert {
    __turbopack_var__: true
};
...
import { _ as patchFetch } from "__TURBOPACK_PART__" assert {
    __turbopack_part__: 16
};
...
import { _ as requestAsyncStorage } from "__TURBOPACK_PART__" assert {
    __turbopack_part__: 13
};
