...
const x1 = externalFunction();
export { x1 as _ } from "__TURBOPACK_VAR__" assert {
    __turbopack_var__: true
};
...
const x2 = externalFunction();
export { x2 as _ } from "__TURBOPACK_VAR__" assert {
    __turbopack_var__: true
};
...
export { func as _ } from "__TURBOPACK_VAR__" assert {
    __turbopack_var__: true
};
...
import { _ as func } from "__TURBOPACK_PART__" assert {
    __turbopack_part__: 9
};
export { func };
