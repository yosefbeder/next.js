...
```js
import { createConnection } from "node:net";
export { createConnection as _ } from "__TURBOPACK_VAR__" assert {
...
```js
import { parse as parseStackTrace } from "../compiled/stacktrace-parser";
export { parseStackTrace as _ } from "__TURBOPACK_VAR__" assert {
    __turbopack_var__: true
};
...
```js
import { getProperError } from "./error";
export { getProperError as _ } from "__TURBOPACK_VAR__" assert {
    __turbopack_var__: true
};
...
import { _ as parseStackTrace } from "__TURBOPACK_PART__" assert {
    __turbopack_part__: 1
};
import { _ as getProperError } from "__TURBOPACK_PART__" assert {
    __turbopack_part__: 2
};
...
export { structuredError as _ } from "__TURBOPACK_VAR__" assert {
    __turbopack_var__: true
};
...
import { _ as structuredError } from "__TURBOPACK_PART__" assert {
    __turbopack_part__: 3
};
import { _ as createConnection } from "__TURBOPACK_PART__" assert {
    __turbopack_part__: 0
};
function createIpc(port) {
    const socket = createConnection(port, "127.0.0.1");
...
export { createIpc as _ } from "__TURBOPACK_VAR__" assert {
    __turbopack_var__: true
};
...
const PORT = process.argv[2];
export { PORT as _ } from "__TURBOPACK_VAR__" assert {
    __turbopack_var__: true
};
...
import { _ as createIpc } from "__TURBOPACK_PART__" assert {
    __turbopack_part__: 4
};
import { _ as PORT } from "__TURBOPACK_PART__" assert {
    __turbopack_part__: 9
};
const IPC = createIpc(parseInt(PORT, 10));
export { IPC as _ } from "__TURBOPACK_VAR__" assert {
    __turbopack_var__: true
};
...
import { _ as IPC } from "__TURBOPACK_PART__" assert {
    __turbopack_part__: 10
};
process.on("uncaughtException", (err)=>{
    IPC.sendError(err);
...
export { improveConsole as _ } from "__TURBOPACK_VAR__" assert {
    __turbopack_var__: true
};
...
import { _ as improveConsole } from "__TURBOPACK_PART__" assert {
    __turbopack_part__: 13
};
improveConsole("error", "stderr", true);
