...
```js
let x = 1;
export { x as _ } from "__TURBOPACK_VAR__" assert {
...
import { _ as x } from "__TURBOPACK_PART__" assert {
    __turbopack_part__: 0
};
x = 3;
...
const y = x;
export { y as _ } from "__TURBOPACK_VAR__" assert {
    __turbopack_var__: true
};
...
import { _ as y } from "__TURBOPACK_PART__" assert {
    __turbopack_part__: 10
};
export { y };
