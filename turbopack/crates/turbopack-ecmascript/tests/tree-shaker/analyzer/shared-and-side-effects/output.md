...
const value = externalFunction();
export { value as _ } from "__TURBOPACK_VAR__" assert {
...
const value2 = externalObject.propertyWithGetter;
export { value2 as _ } from "__TURBOPACK_VAR__" assert {
    __turbopack_var__: true
};
...
const value3 = externalFunction();
export { value3 as _ } from "__TURBOPACK_VAR__" assert {
    __turbopack_var__: true
};
...
import { _ as value } from "__TURBOPACK_PART__" assert {
    __turbopack_part__: 1
};
import { _ as value2 } from "__TURBOPACK_PART__" assert {
    __turbopack_part__: 2
};
import { _ as value3 } from "__TURBOPACK_PART__" assert {
    __turbopack_part__: 4
};
const shared = {
    value,
...
export { shared as _ } from "__TURBOPACK_VAR__" assert {
    __turbopack_var__: true
};
...
import { _ as shared } from "__TURBOPACK_PART__" assert {
    __turbopack_part__: 5
};
console.log(shared);
...
export { b as _ } from "__TURBOPACK_VAR__" assert {
    __turbopack_var__: true
};
...
import { _ as b } from "__TURBOPACK_PART__" assert {
    __turbopack_part__: 10
};
export { b };
