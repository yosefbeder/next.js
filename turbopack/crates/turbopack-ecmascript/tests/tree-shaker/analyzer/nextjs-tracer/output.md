...
export { isPromise as _ } from "__TURBOPACK_VAR__" assert {
...
export { LogSpanAllowList as _ } from "__TURBOPACK_VAR__" assert {
    __turbopack_var__: true
};
...
export { NextVanillaSpanAllowlist as _ } from "__TURBOPACK_VAR__" assert {
    __turbopack_var__: true
};
...
export { clientTraceDataSetter as _ } from "__TURBOPACK_VAR__" assert {
    __turbopack_var__: true
};
...
```js
let lastSpanId = 0;
export { lastSpanId as _ } from "__TURBOPACK_VAR__" assert {
    __turbopack_var__: true
};
...
import { _ as lastSpanId } from "__TURBOPACK_PART__" assert {
    __turbopack_part__: 4
};
const getSpanId = ()=>lastSpanId++;
export { getSpanId as _ } from "__TURBOPACK_VAR__" assert {
    __turbopack_var__: true
};
...
export { BubbledError as _ } from "__TURBOPACK_VAR__" assert {
    __turbopack_var__: true
};
...
import { _ as BubbledError } from "__TURBOPACK_PART__" assert {
    __turbopack_part__: 6
};
export { BubbledError };
...
export { isBubbledError as _ } from "__TURBOPACK_VAR__" assert {
    __turbopack_var__: true
};
...
import { _ as isBubbledError } from "__TURBOPACK_PART__" assert {
    __turbopack_part__: 8
};
...
```js
let api;
export { api as _ } from "__TURBOPACK_VAR__" assert {
    __turbopack_var__: true
};
...
import { _ as api } from "__TURBOPACK_PART__" assert {
    __turbopack_part__: 11
};
if (process.env.NEXT_RUNTIME === 'edge') {
    api = require('@opentelemetry/api');
...
const rootSpanAttributesStore = new Map();
export { rootSpanAttributesStore as _ } from "__TURBOPACK_VAR__" assert {
    __turbopack_var__: true
};
...
const { context, propagation, trace, SpanStatusCode, SpanKind, ROOT_CONTEXT } = api;
export { context as _ } from "__TURBOPACK_VAR__" assert {
    __turbopack_var__: true
};
export { propagation as _ } from "__TURBOPACK_VAR__" assert {
    __turbopack_var__: true
};
export { trace as _ } from "__TURBOPACK_VAR__" assert {
    __turbopack_var__: true
};
export { SpanStatusCode as _ } from "__TURBOPACK_VAR__" assert {
    __turbopack_var__: true
};
export { SpanKind as _ } from "__TURBOPACK_VAR__" assert {
    __turbopack_var__: true
};
export { ROOT_CONTEXT as _ } from "__TURBOPACK_VAR__" assert {
    __turbopack_var__: true
};
...
import { _ as SpanKind } from "__TURBOPACK_PART__" assert {
    __turbopack_part__: 15
};
...
const rootSpanIdKey = api.createContextKey('next.rootSpanId');
export { rootSpanIdKey as _ } from "__TURBOPACK_VAR__" assert {
    __turbopack_var__: true
};
...
import { _ as SpanStatusCode } from "__TURBOPACK_PART__" assert {
    __turbopack_part__: 15
};
const closeSpanWithError = (span, error)=>{
    if (isBubbledError(error) && error.bubble) {
...
export { closeSpanWithError as _ } from "__TURBOPACK_VAR__" assert {
    __turbopack_var__: true
};
...
import { _ as trace } from "__TURBOPACK_PART__" assert {
    __turbopack_part__: 15
};
import { _ as context } from "__TURBOPACK_PART__" assert {
    __turbopack_part__: 15
};
import { _ as propagation } from "__TURBOPACK_PART__" assert {
    __turbopack_part__: 15
};
import { _ as clientTraceDataSetter } from "__TURBOPACK_PART__" assert {
    __turbopack_part__: 3
};
import { _ as NextVanillaSpanAllowlist } from "__TURBOPACK_PART__" assert {
    __turbopack_part__: 2
};
import { _ as ROOT_CONTEXT } from "__TURBOPACK_PART__" assert {
    __turbopack_part__: 15
};
import { _ as getSpanId } from "__TURBOPACK_PART__" assert {
    __turbopack_part__: 5
};
import { _ as rootSpanIdKey } from "__TURBOPACK_PART__" assert {
    __turbopack_part__: 17
};
import { _ as rootSpanAttributesStore } from "__TURBOPACK_PART__" assert {
    __turbopack_part__: 13
};
import { _ as LogSpanAllowList } from "__TURBOPACK_PART__" assert {
    __turbopack_part__: 1
};
import { _ as closeSpanWithError } from "__TURBOPACK_PART__" assert {
    __turbopack_part__: 18
};
import { _ as isPromise } from "__TURBOPACK_PART__" assert {
    __turbopack_part__: 0
};
class NextTracerImpl {
    getTracerInstance() {
...
export { NextTracerImpl as _ } from "__TURBOPACK_VAR__" assert {
    __turbopack_var__: true
};
...
import { _ as NextTracerImpl } from "__TURBOPACK_PART__" assert {
    __turbopack_part__: 20
};
const getTracer = (()=>{
    const tracer = new NextTracerImpl();
...
export { getTracer as _ } from "__TURBOPACK_VAR__" assert {
    __turbopack_var__: true
};
...
import { _ as getTracer } from "__TURBOPACK_PART__" assert {
    __turbopack_part__: 21
};
