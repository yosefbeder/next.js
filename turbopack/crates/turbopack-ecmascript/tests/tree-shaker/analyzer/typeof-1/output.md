...
```js
import { MyModuleClientComponent } from 'my-module/MyModuleClientComponent';
export { MyModuleClientComponent as _ } from "__TURBOPACK_VAR__" assert {
...
```js
import { ClientComponent } from '../../ClientComponent';
export { ClientComponent as _ } from "__TURBOPACK_VAR__" assert {
    __turbopack_var__: true
};
...
import { _ as MyModuleClientComponent } from "__TURBOPACK_PART__" assert {
    __turbopack_part__: 0
};
import { _ as NextResponse } from "__TURBOPACK_PART__" assert {
    __turbopack_part__: 2
};
import { _ as ClientComponent } from "__TURBOPACK_PART__" assert {
    __turbopack_part__: 1
};
function GET() {
    return NextResponse.json({
