...
export { validateURL as _ } from "__TURBOPACK_VAR__" assert {
...
export { toNodeOutgoingHttpHeaders as _ } from "__TURBOPACK_VAR__" assert {
    __turbopack_var__: true
};
...
```js
import { NextURL } from '../next-url';
export { NextURL as _ } from "__TURBOPACK_VAR__" assert {
    __turbopack_var__: true
};
...
```js
import { ReflectAdapter } from './adapters/reflect';
export { ReflectAdapter as _ } from "__TURBOPACK_VAR__" assert {
    __turbopack_var__: true
};
...
export { handleMiddlewareField as _ } from "__TURBOPACK_VAR__" assert {
    __turbopack_var__: true
};
...
```js
import { stringifyCookie } from '../../web/spec-extension/cookies';
export { stringifyCookie as _ } from "__TURBOPACK_VAR__" assert {
    __turbopack_var__: true
};
...
```js
import { ResponseCookies } from './cookies';
export { ResponseCookies as _ } from "__TURBOPACK_VAR__" assert {
    __turbopack_var__: true
};
...
const INTERNALS = Symbol('internal response');
export { INTERNALS as _ } from "__TURBOPACK_VAR__" assert {
    __turbopack_var__: true
};
...
export { REDIRECTS as _ } from "__TURBOPACK_VAR__" assert {
    __turbopack_var__: true
};
...
import { _ as ResponseCookies } from "__TURBOPACK_PART__" assert {
    __turbopack_part__: 6
};
import { _ as stringifyCookie } from "__TURBOPACK_PART__" assert {
    __turbopack_part__: 5
};
import { _ as handleMiddlewareField } from "__TURBOPACK_PART__" assert {
    __turbopack_part__: 4
};
import { _ as ReflectAdapter } from "__TURBOPACK_PART__" assert {
    __turbopack_part__: 3
};
import { _ as INTERNALS } from "__TURBOPACK_PART__" assert {
    __turbopack_part__: 12
};
import { _ as NextURL } from "__TURBOPACK_PART__" assert {
    __turbopack_part__: 2
};
import { _ as toNodeOutgoingHttpHeaders } from "__TURBOPACK_PART__" assert {
    __turbopack_part__: 1
};
import { _ as validateURL } from "__TURBOPACK_PART__" assert {
    __turbopack_part__: 0
};
import { _ as REDIRECTS } from "__TURBOPACK_PART__" assert {
    __turbopack_part__: 13
};
