...
```js
import { DynamicServerError } from '../../client/components/hooks-server-context';
export { DynamicServerError as _ } from "__TURBOPACK_VAR__" assert {
...
```js
import { StaticGenBailoutError } from '../../client/components/static-generation-bailout';
export { StaticGenBailoutError as _ } from "__TURBOPACK_VAR__" assert {
    __turbopack_var__: true
};
...
```js
import { getPathname } from '../../lib/url';
export { getPathname as _ } from "__TURBOPACK_VAR__" assert {
    __turbopack_var__: true
};
...
export { formatDynamicAPIAccesses as _ } from "__TURBOPACK_VAR__" assert {
    __turbopack_var__: true
};
...
import { _ as formatDynamicAPIAccesses } from "__TURBOPACK_PART__" assert {
    __turbopack_part__: 3
};
...
export { usedDynamicAPIs as _ } from "__TURBOPACK_VAR__" assert {
    __turbopack_var__: true
};
...
import { _ as usedDynamicAPIs } from "__TURBOPACK_PART__" assert {
    __turbopack_part__: 5
};
...
export { createPrerenderState as _ } from "__TURBOPACK_VAR__" assert {
    __turbopack_var__: true
};
...
import { _ as createPrerenderState } from "__TURBOPACK_PART__" assert {
    __turbopack_part__: 7
};
...
```js
import React from 'react';
export { React as _ } from "__TURBOPACK_VAR__" assert {
    __turbopack_var__: true
};
...
import { _ as React } from "__TURBOPACK_PART__" assert {
    __turbopack_part__: 9
};
const hasPostpone = typeof React.unstable_postpone === 'function';
export { hasPostpone as _ } from "__TURBOPACK_VAR__" assert {
    __turbopack_var__: true
};
...
import { _ as hasPostpone } from "__TURBOPACK_PART__" assert {
    __turbopack_part__: 10
};
function assertPostpone() {
    if (!hasPostpone) {
...
export { assertPostpone as _ } from "__TURBOPACK_VAR__" assert {
    __turbopack_var__: true
};
...
import { _ as assertPostpone } from "__TURBOPACK_PART__" assert {
    __turbopack_part__: 11
};
...
export { createPostponedAbortSignal as _ } from "__TURBOPACK_VAR__" assert {
    __turbopack_var__: true
};
...
import { _ as createPostponedAbortSignal } from "__TURBOPACK_PART__" assert {
    __turbopack_part__: 12
};
...
export { postponeWithTracking as _ } from "__TURBOPACK_VAR__" assert {
    __turbopack_var__: true
};
...
import { _ as postponeWithTracking } from "__TURBOPACK_PART__" assert {
    __turbopack_part__: 14
};
...
export { trackDynamicFetch as _ } from "__TURBOPACK_VAR__" assert {
    __turbopack_var__: true
};
...
import { _ as trackDynamicFetch } from "__TURBOPACK_PART__" assert {
    __turbopack_part__: 15
};
...
export { Postpone as _ } from "__TURBOPACK_VAR__" assert {
    __turbopack_var__: true
};
...
import { _ as Postpone } from "__TURBOPACK_PART__" assert {
    __turbopack_part__: 17
};
export { Postpone };
...
import { _ as DynamicServerError } from "__TURBOPACK_PART__" assert {
    __turbopack_part__: 0
};
import { _ as getPathname } from "__TURBOPACK_PART__" assert {
    __turbopack_part__: 2
};
import { _ as StaticGenBailoutError } from "__TURBOPACK_PART__" assert {
    __turbopack_part__: 1
};
import { _ as postponeWithTracking } from "__TURBOPACK_PART__" assert {
    __turbopack_part__: 14
...
export { trackDynamicDataAccessed as _ } from "__TURBOPACK_VAR__" assert {
    __turbopack_var__: true
};
...
import { _ as trackDynamicDataAccessed } from "__TURBOPACK_PART__" assert {
    __turbopack_part__: 19
};
...
export { markCurrentScopeAsDynamic as _ } from "__TURBOPACK_VAR__" assert {
    __turbopack_var__: true
};
...
import { _ as markCurrentScopeAsDynamic } from "__TURBOPACK_PART__" assert {
    __turbopack_part__: 21
};
