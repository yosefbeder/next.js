...
export { getSocketProtocol as _ } from "__TURBOPACK_VAR__" assert {
...
```js
let source;
export { source as _ } from "__TURBOPACK_VAR__" assert {
    __turbopack_var__: true
};
...
```js
const eventCallbacks = [];
export { eventCallbacks as _ } from "__TURBOPACK_VAR__" assert {
    __turbopack_var__: true
};
...
import { _ as getSocketProtocol } from "__TURBOPACK_PART__" assert {
    __turbopack_part__: 0
};
import { _ as source } from "__TURBOPACK_PART__" assert {
    __turbopack_part__: 1
};
import { _ as eventCallbacks } from "__TURBOPACK_PART__" assert {
    __turbopack_part__: 2
};
...
export { connectHMR as _ } from "__TURBOPACK_VAR__" assert {
    __turbopack_var__: true
};
...
import { _ as connectHMR } from "__TURBOPACK_PART__" assert {
    __turbopack_part__: 3
};
export { connectHMR };
...
export { sendMessage as _ } from "__TURBOPACK_VAR__" assert {
    __turbopack_var__: true
};
...
import { _ as sendMessage } from "__TURBOPACK_PART__" assert {
    __turbopack_part__: 5
};
export { sendMessage };
...
export { addMessageListener as _ } from "__TURBOPACK_VAR__" assert {
    __turbopack_var__: true
};
...
import { _ as addMessageListener } from "__TURBOPACK_PART__" assert {
    __turbopack_part__: 7
};
